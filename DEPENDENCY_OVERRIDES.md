...
| `minimatch` | `10.2.2` | Enforces patched minimatch across transitive chains to close GHSA-3ppc-4f35-3m26. |
...
```bash
npm ls minimatch @isaacs/brace-expansion @electron/get unzipper archiver test-exclude
npm audit
```

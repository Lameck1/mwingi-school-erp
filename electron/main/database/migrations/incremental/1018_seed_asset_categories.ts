...
export function up(db: Database): void {
    const categories = [
        { name: 'Furniture & Fittings', method: 'STRAIGHT_LINE', life: 10, rate: 10 },
        { name: 'Computer Equipment', method: 'DECLINING_BALANCE', life: 3, rate: 33.3 },
        { name: 'Vehicles', method: 'STRAIGHT_LINE', life: 5, rate: 20 },
        { name: 'Land & Buildings', method: 'STRAIGHT_LINE', life: 50, rate: 2 }
    ]

...
export function up(db: Database): void {
  ...
  console.info('Migration 011: Chart of Accounts & Double-Entry Ledger completed');
}
...
export function down(db: Database): void {
  ...
  // eslint-disable-next-line no-console
  console.info('Migration 011: Rolled back Chart of Accounts & Double-Entry Ledger');
}

                    ...
                    {templates.map(template => (
                        <div key={template.id} className="premium-card group relative hover:border-primary/30 transition-all duration-300">
                            <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                <button className="p-2 rounded-lg bg-secondary/80 hover:bg-primary/20 text-foreground hover:text-primary transition-all">
                ...
                <div className="space-y-6">
                    <div className="grid grid-cols-2 gap-6">
                        <div className="space-y-2">
                            <label className="text-[10px] font-bold text-foreground/50 uppercase tracking-widest ml-1">Template Name</label>
                            <input
                                type="text"
                        ...
                        <div className="space-y-2">
                            <label className="text-[10px] font-bold text-foreground/50 uppercase tracking-widest ml-1">Category</label>
                            <select
                    ...
                    <div className="space-y-2">
                        <label className="text-[10px] font-bold text-foreground/50 uppercase tracking-widest ml-1">Delivery Channel</label>
                    ...
                    {editingTemplate.template_type === 'EMAIL' && (
                        <div className="space-y-2 animate-in slide-in-from-top-2">
                            <label className="text-[10px] font-bold text-foreground/50 uppercase tracking-widest ml-1">Email Subject</label>
                            <input
                                type="text"
                    ...
                    <div className="space-y-2">
                        <label className="text-[10px] font-bold text-foreground/50 uppercase tracking-widest ml-1">Message Body</label>
                        <textarea
                            rows={6}
                    ...
                    <div className="flex justify-end gap-3 pt-4 border-t border-border/20">
                        <button onClick={() => setShowTemplateModal(false)} className="btn btn-secondary px-8">Discard</button>
                        <button onClick={handleSaveTemplate} disabled={saving} className="btn btn-primary px-8 flex items-center gap-2 shadow-xl shadow-primary/20">

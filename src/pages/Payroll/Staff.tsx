...
import { useStaff, type StaffFormState } from './useStaff'
...
interface StaffTableCardProps {
    ...
    handleToggleActive: (member: StaffMember, desired: boolean) => Promise<void>
}

function StaffTableCard({ staff, loading, saving, openCreate, openEdit, handleToggleActive }: Readonly<StaffTableCardProps>) {
    if (loading) {
        return (
...
function StaffFormModal({ showModal, setShowModal, editing, form, setForm, handleSave, saving }: Readonly<StaffFormModalProps>) {
    return (
        <Modal
            isOpen={showModal}
...
export default function Staff() {
    const {
        staff, loading, showModal, saving, editing, form,
        setShowModal, setForm, openCreate, openEdit, handleSave, handleToggleActive,
    } = useStaff()

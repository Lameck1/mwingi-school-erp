export interface DataImportAPI {
  importData: (filePath: string, config: unknown) => Promise<{ success: boolean; totalRows: number; imported: number; skipped: number; errors: Array<{ row: number; message: string }> }>
